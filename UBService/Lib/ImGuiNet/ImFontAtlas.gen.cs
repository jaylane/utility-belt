...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImFontAtlasPtr
    {
        ...
        public ref byte Locked => ref NativePtr->Locked;
        public ref byte TexReady => ref NativePtr->TexReady;
        public ref byte TexPixelsUseColors => ref NativePtr->TexPixelsUseColors;
        ...
        public ImPtrVector<ImFontAtlasCustomRectPtr> CustomRects => new ImPtrVector<ImFontAtlasCustomRectPtr>(NativePtr->CustomRects, Marshal.SizeOf(typeof(ImFontAtlasCustomRect)));
        public ImPtrVector<ImFontConfigPtr> ConfigData => new ImPtrVector<ImFontConfigPtr>(NativePtr->ConfigData, Marshal.SizeOf(typeof(ImFontConfig)));
