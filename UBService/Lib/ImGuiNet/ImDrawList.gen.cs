...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImDrawListPtr
    {
        ...
        public ImPtrVector<ImDrawCmdPtr> CmdBuffer => new ImPtrVector<ImDrawCmdPtr>(NativePtr->CmdBuffer, Marshal.SizeOf(typeof(ImDrawCmd)));
        public ImVector<ushort> IdxBuffer => new ImVector<ushort>(NativePtr->IdxBuffer);
        public ImPtrVector<ImDrawVertPtr> VtxBuffer => new ImPtrVector<ImDrawVertPtr>(NativePtr->VtxBuffer, Marshal.SizeOf(typeof(ImDrawVert)));
