...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImFontPtr
    {
        ...
        public ImPtrVector<ImFontGlyphPtr> Glyphs => new ImPtrVector<ImFontGlyphPtr>(NativePtr->Glyphs, Marshal.SizeOf(typeof(ImFontGlyph)));
        ...
        public ref ushort DotChar => ref NativePtr->DotChar;
        public ref byte DirtyLookupTables => ref NativePtr->DirtyLookupTables;
