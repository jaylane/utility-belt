...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiViewportPtr
    {
        ...
        public ref byte PlatformRequestMove => ref NativePtr->PlatformRequestMove;
        public ref byte PlatformRequestResize => ref NativePtr->PlatformRequestResize;
        public ref byte PlatformRequestClose => ref NativePtr->PlatformRequestClose;
        public void Destroy()
        {
