...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiIOPtr
    {
        ...
        public ref byte ConfigDockingAlwaysTabBar => ref NativePtr->ConfigDockingAlwaysTabBar;
        public ref byte ConfigDockingTransparentPayload => ref NativePtr->ConfigDockingTransparentPayload;
        public ref byte ConfigViewportsNoAutoMerge => ref NativePtr->ConfigViewportsNoAutoMerge;
        public ref byte ConfigViewportsNoTaskBarIcon => ref NativePtr->ConfigViewportsNoTaskBarIcon;
        public ref byte ConfigViewportsNoDecoration => ref NativePtr->ConfigViewportsNoDecoration;
        public ref byte ConfigViewportsNoDefaultParent => ref NativePtr->ConfigViewportsNoDefaultParent;
        public ref byte MouseDrawCursor => ref NativePtr->MouseDrawCursor;
        public ref byte ConfigMacOSXBehaviors => ref NativePtr->ConfigMacOSXBehaviors;
        public ref byte ConfigInputTrickleEventQueue => ref NativePtr->ConfigInputTrickleEventQueue;
        public ref byte ConfigInputTextCursorBlink => ref NativePtr->ConfigInputTextCursorBlink;
        public ref byte ConfigDragClickToInputText => ref NativePtr->ConfigDragClickToInputText;
        public ref byte ConfigWindowsResizeFromEdges => ref NativePtr->ConfigWindowsResizeFromEdges;
        public ref byte ConfigWindowsMoveFromTitleBarOnly => ref NativePtr->ConfigWindowsMoveFromTitleBarOnly;
        ...
        public ref IntPtr GetClipboardTextFn => ref NativePtr->GetClipboardTextFn;
        public ref IntPtr SetClipboardTextFn => ref NativePtr->SetClipboardTextFn;
        public IntPtr ClipboardUserData { get => (IntPtr)NativePtr->ClipboardUserData; set => NativePtr->ClipboardUserData = (void*)value; }
        public ref IntPtr SetPlatformImeDataFn => ref NativePtr->SetPlatformImeDataFn;
        public IntPtr _UnusedPadding { get => (IntPtr)NativePtr->_UnusedPadding; set => NativePtr->_UnusedPadding = (void*)value; }
        public ref byte WantCaptureMouse => ref NativePtr->WantCaptureMouse;
        public ref byte WantCaptureKeyboard => ref NativePtr->WantCaptureKeyboard;
        public ref byte WantTextInput => ref NativePtr->WantTextInput;
        public ref byte WantSetMousePos => ref NativePtr->WantSetMousePos;
        public ref byte WantSaveIniSettings => ref NativePtr->WantSaveIniSettings;
        public ref byte NavActive => ref NativePtr->NavActive;
        public ref byte NavVisible => ref NativePtr->NavVisible;
        ...
        public ref int MetricsActiveAllocations => ref NativePtr->MetricsActiveAllocations;
        ...
        public ref byte KeyCtrl => ref NativePtr->KeyCtrl;
        public ref byte KeyShift => ref NativePtr->KeyShift;
        public ref byte KeyAlt => ref NativePtr->KeyAlt;
        public ref byte KeySuper => ref NativePtr->KeySuper;
        public RangeAccessor<float> NavInputs => new RangeAccessor<float>(NativePtr->NavInputs, 20);
        public ref ImGuiKeyModFlags KeyMods => ref NativePtr->KeyMods;
        public ref ImGuiKeyModFlags KeyModsPrev => ref NativePtr->KeyModsPrev;
        public RangeAccessor<ImGuiKeyData> KeysData => new RangeAccessor<ImGuiKeyData>(&NativePtr->KeysData_0, 645);
        public ref byte WantCaptureMouseUnlessPopupClose => ref NativePtr->WantCaptureMouseUnlessPopupClose;
        ...
        public ref byte AppFocusLost => ref NativePtr->AppFocusLost;
        public ref sbyte BackendUsingLegacyKeyArrays => ref NativePtr->BackendUsingLegacyKeyArrays;
        public ref byte BackendUsingLegacyNavInputArray => ref NativePtr->BackendUsingLegacyNavInputArray;
