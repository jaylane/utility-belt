...
namespace UtilityBelt.Lib.ItemInfoHelper {
    public static class Dictionaries {
        ...
        public static Dictionary<int, string> AttributeSetInfo = new Dictionary<int, string>
        {
            ...
            { 138, "Paragon" }, // Possibly Paragon Missile Weapons
			{ 139, "Paragon" }, // Possibly Paragon Casters
			{ 140, "Paragon" }, // Possibly Paragon Melee Weapons
		};
        ...
        const int LongValueKey_ElementalDamageBonus = 204;

        public static readonly Dictionary<int, List<SpellInfo<int>>> LongValueKeySpellEffects = new Dictionary<int, List<SpellInfo<int>>>()
        {
			// In 2012 they removed these item spells and converted them to auras that are cast on the player, not on the item.
			{ 1616, new List<SpellInfo<int>>(){new SpellInfo<int>(LongValueKey_MaxDamage, 20)} }, // Blood Drinker VI
			{ 2096, new List<SpellInfo<int>>(){new SpellInfo<int>(LongValueKey_MaxDamage, 22)} }, // Infected Caress
			...
			//{ 4661, new SpellInfo<int>(LongValueKey_ElementalDamageBonus, 7, 7)}, // Epic Blood Thirst
			//{ 6089, new SpellInfo<int>(LongValueKey_ElementalDamageBonus, 10, 10)}, // Legendary Blood Thirst

			{ 3688, new List<SpellInfo<int>>(){new SpellInfo<int>(LongValueKey_MaxDamage, 300)} }, // Prodigal Blood Drinker

			{ 1486, new List<SpellInfo<int>>(){new SpellInfo<int>(LongValueKey_ArmorLevel, 200)} }, // Impenetrability VI
			{ 2108, new List<SpellInfo<int>>(){new SpellInfo<int>(LongValueKey_ArmorLevel, 220)} }, // Brogard's Defiance
			{ 4407, new List<SpellInfo<int>>(){new SpellInfo<int>(LongValueKey_ArmorLevel, 240)} }, // Incantation of Impenetrability
                        
			{ 2604, new List<SpellInfo<int>>(){new SpellInfo<int>(LongValueKey_ArmorLevel, 20, 20)} }, // Minor Impenetrability
			{ 2592, new List<SpellInfo<int>>(){new SpellInfo<int>(LongValueKey_ArmorLevel, 40, 40)} }, // Major Impenetrability
			{ 4667, new List<SpellInfo<int>>(){new SpellInfo<int>(LongValueKey_ArmorLevel, 60, 60)} }, // Epic Impenetrability
			{ 6095, new List<SpellInfo<int>>(){new SpellInfo<int>(LongValueKey_ArmorLevel, 80, 80)} }, // Legendary Impenetrability
		};
