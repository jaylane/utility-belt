...
namespace AcClient {
    ...
    public unsafe struct ACCmdInterp {
        ...
        public void SetMotion(UInt32 motion, bool fOn) => ((delegate* unmanaged[Thiscall]<ref ACCmdInterp, UInt32, bool, void>)0x0058C140)(ref this, motion, fOn); // .text:0058B310 ; void __thiscall ACCmdInterp::SetMotion(ACCmdInterp *this, unsigned int motion, bool fOn) .tet:0058B310 ?SetMotion@ACCmdInterp@@IAEXK_N@Z
